...
/* Macros --------------------------------------------------------------------*/
//#define WIFI_RESET_MODULE()       WIFI_RESET_PORT->BRR |= WIFI_RESET_PIN;\
//                                  WIFI_DELAY(10);\
//                                  WIFI_RESET_PORT->BSRR |= WIFI_RESET_PIN;\
//                                  WIFI_DELAY(500)


//#define WIFI_ENABLE_NSS()         SPI3_NSS_PORT->BRR |= SPI3_NSS_PIN;\
//                                  WIFI_DELAY(10)


//#define WIFI_DISABLE_NSS()        SPI3_NSS_PORT->BSRR |= SPI3_NSS_PIN;\
//                                  WIFI_DELAY(10)


//#define WIFI_IS_READY()           ((WIFI_READY_PORT->IDR & WIFI_READY_PIN) == GPIO_PIN_SET)

//#define WIFI_DELAY(ms)						LL_mDelay(ms)
